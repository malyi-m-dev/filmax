...
feature/
├─ onboarding/ home/ search/ library/ profile/ details/ player/
│     └─ каждая: <feature>(логика) + <feature>:mobile + <feature>:tv
├─ categories/tv/            # Жанры — только ТВ
└─ collections/ designsystem/  # пока только телефон
```
...
- **Телефон** (нижний таб-бар): Главная · Поиск · Подборки · Библиотека · Профиль, плюс
  Детали и Плеер.
- **Android TV** (верхний таб-бар, D-pad): Главная · Поиск · Жанры · Библиотека · Профиль,
  плюс Детали и Плеер.
...
- [ ] **TV: Жанры** — сейчас статический список (нужен эндпоинт жанров каталога).
